...
//Creating List
/*
const citylist = document.querySelector(".citylist ul");
citynamejsondata.forEach((city) => {
  citylist.innerHTML += `<li>${city.name}</li>`;
});*/
...
//   https://api.openweathermap.org/data/2.5/weather?q=vellore&appid=a62c7277b464b130cfcaae8a64c3bc62&units=metric

const inputcity = document.getElementById("inputcity");
const weatherimg = document.getElementById("weatherimg");
const btnsearch = document.getElementById("btnsearch");
const temp = document.querySelector(".extra h2");
const weatherdes= document.querySelector(".extra h4");
...
async function getweather(apiurl,city) {
...
//To make Hide and Show

const weatherimgdiv = document.querySelector(".weather");
const extradiv = document.querySelector(".extra");
const windhumdiv = document.querySelector(".windhum");
...
inputcity.addEventListener("keydown", (e) => {
  if (e.key == "Enter") {
    ...
    if (city.trim() == "" || city == "No Results Found") {
      alert("Cityname Should not be Empty");
    } else {
      setTimeout(getloader, 10);
      setTimeout(() => {
...
inputcity.addEventListener("input", () => {
  ...
  // Perform search or fetch suggestions here
...
function getSuggestions(searchText) {
  // Mock implementation - Replace with your own logic
  return citynamejsondata.filter((suggestion) =>
